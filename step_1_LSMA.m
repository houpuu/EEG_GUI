...
%label:0-face,1-food,2-landscape,3-sick,4-snake,5-spider
...
%输入的数据
file_name1='C:\EEG\eeg_DATA\picutre_emotion\spider';
%LSMA滤波后的数据保存
file_name2='C:\EEG\eeg_DATA\picutre_emotion\LSMA\5-';
