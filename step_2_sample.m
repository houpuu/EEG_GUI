...
%     train_output=zeros(size(train_input,1),1);
%    
...
%%
%step-2，完成step-1之后，再运行step-2

%输入的数据
file_name1='C:\EEG\eeg_DATA\music\music_sample';
%下采样变换后的样本保存
file_name2='C:\EEG\eeg_DATA\music\music_sample\dSample.mat';
input_option.type='dir';
input_option.ext='.mat';
pos_file_list=FileInput(file_name1,input_option);
length_data=length(pos_file_list.data);
